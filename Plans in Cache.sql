...
WHERE databases.name = 'AX_PROD'
and dm_exec_sql_text.text LIKE '%SALESLINEEXPANDED%'
ORDER BY dm_exec_query_stats.max_logical_reads DESC; -- which queries on our server are the most expensive? 



--DROP the cache - pass the plan_handle 
--DBCC FREEPROCCACHE(0x060007006A1244164041EA51050000000000000000000000) ;
